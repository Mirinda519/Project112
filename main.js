...
classifier = ml5.imageClassifier("https://teachablemachine.withgoogle.com/models/1YwR4RgFT/model.json",modelLoaded);
...
function speak()
{
    ...
    speak_data_1="The first gesture is "+prediction_1;
    speak_data_2="The second gesture is "+prediction_2;
